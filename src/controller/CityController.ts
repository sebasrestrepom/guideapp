...
export class CityController {
    ...
    async getByDepartment(@Param ('departmentId')departmentId:string): Promise<GetByDepartmentResponse[] >{
        const cities = await this.cityService.getByDepartment(parseInt(departmentId,10));
