...
describe('UpdateDataSchool should', () => {
    ...
    test('update data school', async () => {
        ...
        await when_update_the_school_with_this_data(school.id , school.cityId, 'Gabo');
    ...
    async function when_update_the_school_with_this_data(id: number, cityId: number, name: string) {
