...
export class CityData1620759925106 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`INSERT INTO city (id, departmentId, code, name) VALUES
    (1, 1, 1, 'MEDELLIN'),
    (2, 1, 2, 'ABEJORRAL'),
    (3, 1, 4, 'ABRIAQUI'),
    (4, 1, 21, 'ALEJANDRIA'),
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`TRUNCATE TABLE city`);
  }
}
